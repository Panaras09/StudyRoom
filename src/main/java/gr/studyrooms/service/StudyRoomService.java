/**
 * Service που περιέχει τη λογική διαχείρισης χώρων μελέτης.
 *
 * Χρησιμοποιείται για την προβολή ενεργών χώρων προς τους φοιτητές και για
 * τη δημιουργία ή ανάγνωση χώρων από το προσωπικό βιβλιοθήκης. Λειτουργεί ως
 * ενδιάμεσο επίπεδο ανάμεσα στους controllers και το StudyRoomRepository.
 */
