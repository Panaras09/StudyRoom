/**
 * Αρχικοποιεί demo δεδομένα κατά την εκκίνηση της εφαρμογής.
 *
 * Δημιουργεί τους βασικούς χρήστες και τους αρχικούς χώρους μελέτης που
 * χρησιμοποιούνται για δοκιμές. Τα δεδομένα μπαίνουν μόνο όταν η βάση είναι άδεια.
 * Αυτό βοηθάει στο demo, επειδή η H2 in-memory βάση ξαναδημιουργείται σε κάθε restart.
 */
